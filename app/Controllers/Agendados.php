...
class Agendados
{
    ...
    public function index()
    {
     ...
     public function onEdit() {
       ...
       $carregarView = new \Core\ConfigView("Views/financeiro/cad_marcacao", $this->dados);
       $carregarView->renderizar();
     }
     ...
     public function onSave(){
        ...
        $this->dados['forma_pagamento_id'] = $_POST["forma_pagamento_id"] ? $_POST["forma_pagamento_id"] : null;
